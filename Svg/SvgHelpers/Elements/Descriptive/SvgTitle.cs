...
{
    /// <summary>
    /// <para>Each container element or graphics element in an SVG drawing can supply a ‘title’ description string where the description is text-only and is not rendered</para>
    /// </summary>
